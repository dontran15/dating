...
// import
// com.nighthawk.spring_portfolio.database.dating.DatingProfileJpaRepository;
...
// Optional<List<DatingProfile>> profiles =
// datingProfileJpaRepository.findAllByOrderByNameAsc();
...
// if (profile.get() == null) {
// return new ResponseEntity<>("Dating profile not found",
